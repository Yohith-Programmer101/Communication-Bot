...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Main Bot access of the Communication-Bot.">
    ...
    <br>
        ...
        <br><br>
        <a class="button" href="https://repl.it/@DremixBotDev/discord-communication-bot#main.py">File Manager</a><br><br>
        <a class="button" href="https://repl.it/@DremixBotDev/discord-communication-bot.zip">Download Files</a>
        </div>
    </body>
    </html>